...
// Create database connection pool (reused across requests)
...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      // This will be tested separately after login if needed
      ...
      console.log(`Setting auth token for user ID: ${user.id}`);
      ...
      connection.release();
      // Don't close the pool - it's reused across requests
    }
  } catch (error) {
